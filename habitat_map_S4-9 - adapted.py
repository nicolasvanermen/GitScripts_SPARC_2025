...
# --------------------------------------------------------------------------------
# Description: steps 4-9 for the creation of ecotope maps for SPARC de-embankments
# ------------------
# Version: Python 27
# ------------------
...
# voor Klein Broek 2025 stropt het script steevast op de reclassify van rel_grens_DD_75_boz_f, nochtans blijkt er weinig verkeerd met
# dit raster bij prospectie in ArcMap; dit probleem werd verholpen door de resolutie van het gebied naar beneden te halen (factor 10)
...
DD25 = Raster(geodatabase + "\\reclass_maj_DD_25")
DD75 = Raster(geodatabase + "\\reclass_maj_DD_75")
LW10 = Raster(geodatabase + "\\reclass_maj_OF_LW_10")
HW90 = Raster(geodatabase + "\\reclass_maj_OF_HW_90")
HW05 = Raster(geodatabase + "\\reclass_maj_OF_BE")
...
fysiotopes = slik + LW10 + HW90 + HW05
